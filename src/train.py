...
def load_corpus(args):
    ...
    corpus = TweetCorpus(args['train_file'], args['val_file'], args['test_file'], args['unld_train_file'], args['unld_val_file'], args['dictionaries_file'], args['user_embeddings_file'])
...
def main(args):
    ...
    if args['mode'] == 'lm':
        ...
        if args['arch_type'] == 'lstm':
            ...
            clf = CNNClassifier(corpus.W, corpus.W_d, args)
